...
\usepackage{enumitem}
\usepackage{pdfpages} % Tambahkan ini untuk memasukkan file PDF
...
\begin{tabular}{p{1cm}p{7cm}p{7cm}}
  ...
  & Prof. Dr. Ir. Suhono Harso Supangkat, M.Eng. & Ir. Devi Willieam Anggara S.T., M.Phil., Ph.D., IPP. \\[0.2cm]
...
% LEMBAR PENGESAHAN 
% ==========================================
% Memasukkan file PDF hasil scan lembar pengesahan
% Pastikan file 'lembar_pengesahan.pdf' sudah ada di folder yang sama dengan file .tex
% \includepdf[pages={1}]{files/lembar_pengesahan_propTA.pdf}
...
\input{Bab III - Analisis-Masalah.tex} % Uncomment jika file sudah ada
\input{Bab IV - Desain-Konsep-Solusi.tex} % Uncomment jika file sudah ada
\input{Bab V - Rencana-Selanjutnya.tex} % Uncomment jika file sudah ada
